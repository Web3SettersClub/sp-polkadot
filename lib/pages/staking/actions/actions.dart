...
import 'package:settpay_ui/components/outlinedCircle.dart';
      ...
      return Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: i.success
                ? SvgPicture.asset(
                    'packages/sp_polkadot/assets/images/staking/ok.svg')
                : SvgPicture.asset(
                    'packages/sp_polkadot/assets/images/staking/error.svg'),
          ),
          title: Text(i.call),
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: SvgPicture.asset(
                'packages/sp_polkadot/assets/images/staking/${isReward ? 'reward' : 'slash'}.svg'),
          ),
