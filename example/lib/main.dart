...
import 'package:sp_polkadot_example/pages/assetsContent.dart';
import 'package:sp_polkadot_example/pages/profileContent.dart';
import 'package:sp_polkadot_example/pages/selectListPage.dart';
...
import 'package:sp_polkadot_example/pages/homePage.dart';
...
class _MyAppState extends State<MyApp> {
  _MyAppState(SettPayPlugin defaultPlugin) : this._network = defaultPlugin;

  SettPayPlugin _network;
  ...
  void _setNetwork(SettPayPlugin network) {
    setState(() {
      _network = network;
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Polkadot SettPay Plugin Demo',
